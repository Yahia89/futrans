...
const services = [
  {
    ...
    image: "/service-wheelchair-Photoroom.png",
    className: "md:col-span-1 md:row-span-2 bg-[#F5F1E9] text-[#4A3728]",
  ...
  },
  {
    ...
    image: "/service-medical-Photoroom.png",
    className: "md:col-span-2 md:row-span-1 bg-[#FF8C3E] text-white",
  ...
  },
  {
    ...
    image: "/service-metro-Photoroom.png",
    className: "md:col-span-1 md:row-span-1 bg-white text-foreground border border-border/10 shadow-sm",
    imageClass: "w-28 h-28 mx-auto mb-6 object-contain",
  ...
  },
  {
    ...
    image: "/service-community-Photoroom.png",
    className: "md:col-span-1 md:row-span-1 bg-[#E9EDF0] text-[#2C3E50]",
    imageClass: "w-full h-40 object-contain mb-4",
    contentClass: "flex flex-col items-center justify-center text-center h-full p-8",
  },
  {
    ...
    image: "/service-waiver-Photoroom.png",
  ...
  },
  {
    ...
    image: "/service-employment-Photoroom.png",
    className: "md:col-span-1 md:row-span-1 bg-[#F0EEE6] text-[#4E4E4E]",
    imageClass: "w-28 h-28 mx-auto mb-6 object-contain",
    contentClass: "flex flex-col items-center justify-center text-center h-full p-8",
  },
];
